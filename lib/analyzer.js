...
export default function analyze(code) {
    ...
    const totalCounts = getTotalCounts(functions)
    console.log(functions);
    console.log(totalCounts);
    return renderAnalysis(functions, totalCounts);
}
...
function getFunctionObjects(code) {
    ...
    while (true) {
        ...
        body = body.replace(regExs.comments, '');
...
function getTotalCounts(functions) {
