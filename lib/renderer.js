...
export default function renderAnalysis(functions) {
    ...
    html += `
    <tr>
        <td align="left">Σ(n<sub>1</sub>) = ${en1} Σ(N<sub>1</sub>) = ${eN1} </td>
        <td align="left">Σ(n<sub>2</sub>) = ${en2} Σ(N<sub>2</sub>) = ${eN2} </td>
        <td align="left">Σ(n<sub>3</sub>) = ${en3} Σ(N<sub>3</sub>) = ${eN3} </td>
    </tr>
    <tr>
        <td colspan="6"><strong>
            Σ(n) = ${n}<br>
